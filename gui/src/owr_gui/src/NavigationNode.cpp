...
NavigationNode::NavigationNode(NavigationGUI *newgui) {
	...
	videoSub[0] = imgTrans.subscribe("/cam0", 1000, &NavigationNode::receiveVideoMsg, this, image_transport::TransportHints("compressed"));
	videoSub[1] = imgTrans.subscribe("/cam1", 1000, &NavigationNode::receiveVideoMsg, this, image_transport::TransportHints("compressed"));
	videoSub[2] = imgTrans.subscribe("/cam2", 1000, &NavigationNode::receiveVideoMsg, this, image_transport::TransportHints("compressed"));
	videoSub[3] = imgTrans.subscribe("/cam3", 1000, &NavigationNode::receiveVideoMsg, this, image_transport::TransportHints("compressed"));
